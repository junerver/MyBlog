...
import com.junerver.myblog.db.dao.DaoMaster;
import com.junerver.myblog.db.dao.DaoSession;
import com.junerver.myblog.db.entity.ArticleEntity;

/**
 * Created by junerver on 2016/8/6.
 */
public class AppContext extends Application {
    ...
    public static ArticleEntityDao articleEntityDao;
    @Override
    ...
    private void setupDatabase() {
        ...
        articleEntityDao = daoSession.getArticleEntityDao();
    }
